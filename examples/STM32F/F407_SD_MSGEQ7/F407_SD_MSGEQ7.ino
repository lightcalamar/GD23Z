...
SdFat SD(2);
const uint8_t SD2_CS = PB9;   // chip select for sd2

//Grupo de assets
char Asset2[] = "barras.gd2"; File GAsset2;  String STRAsset2(Asset2);
...
int strobe = PA11; //5  FT843   2  FT801/FT813 Riverdi    25 T36
int res =    PA12;  //6  FT843   3  FT801/FT813 Riverdi    26 T36
